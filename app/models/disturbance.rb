...
class Disturbance < ApplicationRecord
    ...
    def self.perturbations
        ...
        'Retard estimé de 190 min',
        'Retard estimé de 200 min',
        'Retard estimé de 210 min',
        'Retard estimé de 220 min',
        'Retard estimé de 230 min',
        'Retard estimé de 240 min',
        'Retard estimé de 250 min',
        'Retard estimé de 260 min',
        'Retard estimé de 270 min',
        'Retard estimé de 280 min',
        'Retard estimé de 290 min',
        'Retard estimé de 300 min',
        'Retard estimé de 310 min',
        'Retard estimé de 320 min',
        'Retard estimé de 330 min',
        'Retard estimé de 340 min',
        'Retard estimé de 350 min',
        'Retard estimé de 360 min',
        'Supprimé',
