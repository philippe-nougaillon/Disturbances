class ServicesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.xls do
        book = ServicesToXls.new(@services.first(60000)).call
  ...
  def create
    ...
    respond_to do |format|
      if @service.save
        format.html { redirect_to service_url(@service), notice: "Service créé avec succès." }
  ...
  def update
    respond_to do |format|
      if @service.update(service_params)
        format.html { redirect_to service_url(@service), notice: "Service modifié avec succès." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to services_url, notice: "Service supprimé avec succès." }
