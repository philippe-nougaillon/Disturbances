...
ActiveRecord::Schema[7.0].define(version: 2026_01_30_083504) do
  ...
  create_table "disturbances", force: :cascade do |t|
    ...
    t.index ["date", "train", "perturbation", "information"], name: "super_index_uniq", unique: true
    t.index ["discarded_at"], name: "index_disturbances_on_discarded_at"
    t.index ["perturbation"], name: "index_disturbances_on_perturbation"
